...
export default function ChronologyDetailPage() {
    ...
    const data: Case | undefined = getAllCases().find((c) => c.id === id);
    ...
    return (
        <div className="space-y-6">
            ...
            {items.length > 0 ? (
                ...
                <Card className="p-6 text-sm text-muted-foreground">No timeline events yet.</Card>
            )}
            ...
            <div className="space-y-2">
                ...
                <ul className="list-disc pl-5 text-sm">
                    ...
                    {(!data.timeline || data.timeline.length === 0) && <li className="text-muted-foreground">No sources.</li>}
                </ul>
            </div>
        </div>
    );
