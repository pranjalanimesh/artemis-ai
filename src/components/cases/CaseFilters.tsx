            ...
            <div className="flex flex-col gap-3 md:flex-row md:items-center md:gap-4">
                ...
                <div className="flex items-center gap-2">
                    <div className="flex items-center gap-2">
                        ...
                        <Input type="date" defaultValue={from} onChange={(e) => setQuery(router, params, "from", e.target.value, basePath)} />
                        <span className="text-sm text-muted-foreground">to</span>
                        <Input type="date" defaultValue={to} onChange={(e) => setQuery(router, params, "to", e.target.value, basePath)} />
                    </div>
